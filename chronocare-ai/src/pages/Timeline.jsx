...
import { Calendar, ChevronRight, Plus, Loader, X, FileText } from 'lucide-react';
...
export const Timeline = () => {
  ...
  const getEventIcon = (type) => {
    const icons = { diagnosis: '🏥', surgery: '⚕️', treatment: '💊', vaccination: '💉', checkup: '✓', report: '📄', doctor_note: '🩺' };
    return icons[type] || '•';
  };
                  ...
                  {selectedEvent?._id === event._id && (
                    <div className="mt-4 pt-4 border-t border-gray-100">
                      ...
                      <div className="flex gap-3 mt-4">
                        {event.reportId && (
                          <button 
                            className="btn-honey text-xs py-2 px-4 flex items-center gap-2" 
                            onClick={(e) => { 
                              e.stopPropagation(); 
