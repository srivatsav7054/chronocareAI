...
export const Dashboard = () => {
  ...
  const trendData = healthData?.trend?.length > 0
    ...
    : recentReports.length > 0
      ? [{ 
          month: new Date(recentReports[0].createdAt).toLocaleDateString('en-GB', { day: '2-digit', month: '2-digit', year: '2-digit' }), 
          score 
        }]
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="card">
          ...
          <p className="text-sm font-semibold text-blue-600">
            {recentReports.filter(r => r.fileUrl || (r.fileType !== "text")).length} Documents + {recentReports.filter(r => r.fileType === "text" && !r.fileUrl).length} Text Inputs
          </p>
        </div>
